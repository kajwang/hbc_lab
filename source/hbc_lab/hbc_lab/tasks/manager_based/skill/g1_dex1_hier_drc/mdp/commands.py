...
class G1Dex1HierCommand(CommandTerm):
    cfg: "G1Dex1HierCommandCfg"

    def __init__(self, cfg: "G1Dex1HierCommandCfg", env):
...
@configclass
class G1Dex1HierCommandCfg(CommandTermCfg):
    ...
    grip_visualizer_cfg: VisualizationMarkersCfg = VisualizationMarkersCfg(
        prim_path="/Visuals/G1Dex1HierCommand/grip",
        markers={
    ...
    active_hand_visualizer_cfg: VisualizationMarkersCfg = VisualizationMarkersCfg(
        prim_path="/Visuals/G1Dex1HierCommand/active_hand",
        markers={
...
@configclass
class G1Dex1HierDrcCommandsCfg:
    high_level = G1Dex1HierCommandCfg(
        asset_name="robot",
