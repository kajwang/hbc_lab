#!/usr/bin/env python3
"""Train an HBC Lab RSL-RL policy with the Unitree-style local runner."""
...
tasks = sorted(task_spec.id for task_spec in gym.registry.values() if task_spec.id.startswith("HBC-"))

parser = argparse.ArgumentParser(description="Train an HBC Lab RSL-RL agent.")
